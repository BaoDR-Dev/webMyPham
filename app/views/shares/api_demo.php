...
<div class="wrap">
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/login</div>
        <div class="row">
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/logout</div>
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/profile</div>
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/changePassword</div>
        <div class="row">
    ...
    <div class="card">
        ...
        <div class="url" id="u-products">/webbanhang/Api/products?page=1&limit=6</div>
        <div class="row">
    ...
    <div class="card">
        ...
        <div class="url" id="u-product">/webbanhang/Api/product/{id}</div>
        <div class="row">
    ...
    <div class="card">
        ...
        <div class="url" id="u-search">/webbanhang/Api/search?keyword=...</div>
        <div class="row">
    ...
    <div class="card">
        ...
        <div class="url" id="u-autocomplete">/webbanhang/Api/autocomplete?keyword=...</div>
        <div class="row">
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/categories</div>
    ...
    <div class="card">
        ...
        <div class="url" id="u-categoryProducts">/webbanhang/Api/categoryProducts/{id}</div>
        <div class="row">
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/cart</div>
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/cartAdd — Body: { product_id, quantity }</div>
        <div class="row">
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/cartUpdate — Body: { product_id, quantity }</div>
        <div class="row">
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/cartToggle/{product_id}</div>
        <div class="row">
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/cartRemove/{product_id}</div>
        <div class="row">
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/cartClear</div>
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/orders</div>
    ...
    <div class="card">
        ...
        <div class="url" id="u-order">/webbanhang/Api/order/{id}</div>
        <div class="row">
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/orderCancel/{id}</div>
        <div class="row">
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/ratingStore — Body: { product_id, order_id, rating, review_text }</div>
        <div class="row">
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/promotions</div>
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/myPromotions</div>
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/promotionReceive/{id}</div>
        <div class="row">
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/adminUsers</div>
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/adminUserStatus — Body: { user_id, status }</div>
        <div class="row">
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/adminOrders</div>
    ...
    <div class="card">
        ...
        <div class="url">/webbanhang/Api/adminOrderStatus — Body: { order_id, status }</div>
        <div class="row">
    ...
    <div class="card">
        ...
        <div class="url" id="u-adminDashboard">/webbanhang/Api/adminDashboard</div>
        <div class="row">
...
async function getProducts() {
    ...
    document.getElementById('u-products').textContent = url.replace(BASE, '/webbanhang/Api');
...
async function getProduct() {
    const id = v('p-id');
    document.getElementById('u-product').textContent = `/webbanhang/Api/product/${id}`;
...
async function searchProducts() {
    ...
    document.getElementById('u-search').textContent = url.replace(BASE, '/webbanhang/Api');
    const res = await fetch(url, { headers: { 'X-Requested-With': 'XMLHttpRequest' } });
...
async function autocomplete() {
    ...
    document.getElementById('u-autocomplete').textContent = url.replace(BASE, '/webbanhang/Api');
    const res = await fetch(url, { headers: { 'X-Requested-With': 'XMLHttpRequest' } });
...
async function getCategoryProducts() {
    const id = v('cat-id');
    document.getElementById('u-categoryProducts').textContent = `/webbanhang/Api/categoryProducts/${id}`;
...
async function getOrder() {
    const id = v('o-id');
    document.getElementById('u-order').textContent = `/webbanhang/Api/order/${id}`;
...
async function getDashboard() {
    ...
    document.getElementById('u-adminDashboard').textContent = url.replace(BASE, '/webbanhang/Api');
    const res = await fetch(url, { headers: { 'X-Requested-With': 'XMLHttpRequest' } });
